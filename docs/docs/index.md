...
myst:
  html_meta:
    "description": "A volto add-on that integrates Acumbamail service with Plone"
    "property=og:description": "A volto add-on that integrates Acumbamail service with Plone"
    "property=og:title": "Volto Acumbamail"
    "keywords": "Volto Acumbamail, documentation, A volto add-on that integrates Acumbamail service with Plone"
---

# Volto Acumbamail

Welcome to the documentation for Volto Acumbamail!
